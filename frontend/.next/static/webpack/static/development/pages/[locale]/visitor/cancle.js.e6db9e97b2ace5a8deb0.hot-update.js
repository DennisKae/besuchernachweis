            ...
            if (res) dispatch({
              ...
              payload: {
                rows: res.map(function (p) {
                  return {
                    id: p.id,
                    startDate: "".concat(p.startzeit),
                    name: "".concat(p.besucher[0].name, ", ").concat(p.besucher[0].vorname)
                  };
                }),
                count: res.length
              }
...
//# sourceMappingURL=cancle.js.e6db9e97b2ace5a8deb0.hot-update.js.map