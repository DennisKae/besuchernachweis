            ...
            if (res) dispatch({
              ...
              payload: {
                rows: res.map(function (p) {
                  return {
                    id: p.id,
                    startDate: "".concat(moment__WEBPACK_IMPORTED_MODULE_2___default()(p.startzeit).format('DD.MM.YYYY, HH:mm')),
                    name: "".concat(p.besucher[0].person.name, ", ").concat(p.besucher[0].person.vorname),
                    rooms: p.raeume.map(function (r) {
...
//# sourceMappingURL=cancle.js.941d92f5090413089cde.hot-update.js.map